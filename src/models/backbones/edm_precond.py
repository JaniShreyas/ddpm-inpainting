### EXACT IMPLEMENTATION FROM THE EDM PAPER
### TAKEN FOR REFERENCE WIHTOUT ANY BIAS FROM MY SIDE
### FOR CLEANER COMPARISONS WITH THE ORIGINAL PAPER, AND ALSO HELPING EVALUATE THIS PIPELINE
